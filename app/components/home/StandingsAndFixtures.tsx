...
const StandingsAndFixtures = ({
  ...
  return (
    <div className=' flex flex-col w-full max-w-7xl bg-gradient-to-br from-blue-800/75 to-blue-800/20 lg:flex-row'>
                                ...
                                standings.map((responseData, i) => (
                                    ...
                                    >
                                        ...
                                        w-full">
                                            ...
                                            {
                                                responseData.league.standings[0].map((team : any, j : any) => (
                                                    <Link
                                                        href={`/team/${team.team.id}`}
                                                        key={j + team.team.name}
                                                        className={`flex w-full p-1 hover:bg-blue-800/50
                                                        ${j % 2 === 0 ? 'bg-black/40' : ''}`}
                                                    >
                                                        ...
                                                        <div className="w-2/12 flex justify-center items-center">
                                                            {
                                                                team.form?.split('').map((char : any, i : any) => (
                                                                    <div
                                                                        key={char + i}
