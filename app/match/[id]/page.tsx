...
import getFixtureById from "@/app/getData/getFixtureById"
...
export default async function Match({
    ...
    let fixtureByFixtureId: Fixture | undefined = await getFixtureById(parseInt(params.id));
    ...
    return (
        <div className=" mt-10 flex flex-col w-full justify-center items-center py-10 md:p-10 text-neutral-100">
            ...
            bg-gradient-to-b from-blue-800/60 to-red-800/10">
