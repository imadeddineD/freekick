...
import getFixturesByTeamId from "@/app/getData/getFixturesByTeamId"
import getTeamInfoByTeamId from "@/app/getData/getTeamInfo"
    ...
    return (
        <div className="flex justify-center items-center text-neutral-100 py-5">
            <div className="flex flex-col max-w-7xl p-5 w-full md:flex-row">
                ...
                bg-gradient-to-r from-black/60 to-blue-800/80 h-[500px]">
                    <Image
